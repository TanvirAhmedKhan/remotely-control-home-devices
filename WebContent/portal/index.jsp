...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Dashboard - Remote Device Control</title>
				...
				<div class="navbar-header pull-left">
					<a href="index.html" class="navbar-brand">
						<small>
							...
							Swinburne Remote Device Control
						</small>
					</a>
				</div>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Swinburne</span>
							Remote Device Control  &copy; 2013-2014
						</span>
		...
		<script type="text/javascript">
			jQuery(function($) {
				$("#bootbox-regular").on(ace.click_event, function() {
					bootbox.prompt("How long do you want your device to run?", function(result) {
						if (result === null) {
